...
@Component({
  ...
  template: `
    <div class="ingredient-multiselect">
      <h2 class="prompt">Select ingredients you have or want to use</h2>
...
export class IngredientMultiselectComponent {
  ...
  get suggestions(): string[] {
    if (this.dietType === 'non-vegetarian') {
      return [...INGREDIENT_SUGGESTIONS.vegetarian, ...INGREDIENT_SUGGESTIONS.nonVegetarian];
    }
    return INGREDIENT_SUGGESTIONS.vegetarian;
  }
